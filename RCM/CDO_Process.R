...
system("/usr/local/PanoplyJ/panoply.sh gfdl_RCM3_Future.nc &")
...
hist(mat_dif@data$Mean.Daily.Temperature,col="grey",main="Change (future-current) Mean Annual Temperature",xlab="Change (Degrees C)")
...
system("cdo sub -timmean gfdl_RCM3_Future.nc -timmean gfdl_RCM3_Current.nc GFDL_RCM3_dif.nc")
