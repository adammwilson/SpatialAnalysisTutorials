...
loc=data.frame(latlon="9.15:-79.847",loc="Barrow Colorado Island, Panama",tip="Barrow Colorado Island")
beisp=as.data.frame(bei)
## add origin to plot data using coordinates in Science 25 January 2002(295):5555 DOI: 10.1126/science.1066854
## it's not clear if these coordinates are for the corner or center, so these should not be used for 'real' work, but for display is fine...
...
M1 <- gvisMap(coords, "coords" , options=list(showTip=F,showLine=F, enableScrollWheel=TRUE,
              mapType='hybrid', useMapTypeControl=TRUE,zoomLevel=1,width=800,height=400))
print(M1,"chart")
