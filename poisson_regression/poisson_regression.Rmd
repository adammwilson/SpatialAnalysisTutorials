...
M1 <- gvisMap(loc, "latlon" , "loc", options=
                list(showTip=F,showLine=F, enableScrollWheel=TRUE,
              mapType='hybrid', useMapTypeControl=TRUE,zoomLevel=10,width=800,height=400))
print(M1,"chart")
